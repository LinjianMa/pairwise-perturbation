...
ibrun ./test_ALS -model Tucker -tensor p2 -pp 0 -dim 6 -size 34 -rank 10 -maxiter 250 -filename Tucker_p2_nodes=16_pp=0_dim=6_size=34_rank=10.csv -resprint 10
ibrun ./test_ALS -model Tucker -tensor p2 -pp 1 -dim 6 -size 34 -rank 10 -maxiter 250 -filename Tucker_p2_nodes=16_pp=1_dim=6_size=34_rank=10_restol=1e-2.csv -pp_res_tol 1e-2 -resprint 10
ibrun ./test_ALS -model Tucker -tensor p2 -pp 1 -dim 6 -size 34 -rank 10 -maxiter 250 -filename Tucker_p2_nodes=16_pp=1_dim=6_size=34_rank=10_restol=5e-2.csv -pp_res_tol 5e-2 -resprint 10
