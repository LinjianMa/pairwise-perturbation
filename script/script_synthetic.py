...
for nodes in [1, 16, 256]:
    ...
    text_file.write("ibrun %s -model CP -tensor r -pp 1 -dim 6 -size %s -rank %s -maxiter 250 -filename CP_r_nodes=%s_pp=1_dim=6_size=%s_rank=5_restol=0.005.csv -pp_res_tol 0.005 -resprint 10\n\n" % (exe,size,rank,nodes,size))
    ...
    text_file.write("ibrun %s -model CP -tensor p -pp 1 -dim 8 -size %s -rank %s -maxiter 250 -filename CP_p_nodes=%s_pp=1_dim=8_size=%s_rank=2_restol=0.005.csv -pp_res_tol 0.005 -resprint 10\n\n" % (exe,size,rank,nodes,size))
