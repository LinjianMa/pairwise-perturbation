...
// template<typename dtype>  
// Decomposition<dtype> & Decomposition<dtype>::operator=(Decomposition<dtype> const & other){
// }
...
template<typename dtype>
void Decomposition<dtype>::print_V() const {
	assert(V != NULL);
	V->print();
}

template<typename dtype>
void Decomposition<dtype>::print_W(int i) const {
	assert(W != NULL);
	W[i].print();
}
